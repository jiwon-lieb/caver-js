...
* [caver.klay](api-reference/caver.klay.md)
* [caver.klay.accounts](api-reference/caver.klay.accounts.md)
* [caver.klay.Contract](api-reference/caver.klay.Contract.md)
* [caver.klay.net](api-reference/caver.klay.net.md)
* [caver.klay.abi](api-reference/caver.klay.abi.md)
* [caver.utils](api-reference/caver.utils\_1.4.1.md)
...
Klaytn uses a fixed gas price (25 ston = 25 \* 10^9). A transaction with a different price submitted to the Klaytn network will be rejected. For more information about the gas price, see [Gas and Unit Price Overview](../../../../getting-started/klaytn/design/transaction-fees/#gas-and-unit-price-overview) The price of gas used in the network can be obtained by using [caver.klay.getGasPrice](api-reference/caver.klay/config.md#getgasprice).

If `gasPrice` is not defined when you sign or submit a transaction, caver-js uses the [caver.klay.getGasPrice](api-reference/caver.klay/config.md#getgasprice) RPC call to set the gas price of the transaction.
